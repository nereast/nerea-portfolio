    ...
    return (
        <div className='bg-beige'>
            ...
            <div className='px-[25px] pb-[50px] md:px-[50px] xl:pb-[100px]'>
                <p className='text-black font-bold font-title text-[25px] leading-[27px] md:text-[30px] md:leading-[32px] xl:text-[40px] xl:leading-[42px]'>{t("errofest.project.view_project")} <Button href={t("errofest.project.project_web")} text={t("errofest.project.view_project_here")} number="bottom-[10px]" />.</p>
            </div>
