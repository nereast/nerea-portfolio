...
export const Card = ({ projectName, category, coverImage, href, color }) => {
    ...
    return (
        <Link to={href} className='group'>
            <section className="rounded-[10px] bg-cover h-[300px] md:h-[240px] xl:h-[480px] group-hover:bg-green flex items-end" style={{ backgroundRepeat: 'no-repeat', backgroundImage: `url(${coverImage})` }}>
                <section className={`bg-${color} w-full rounded-[0_0_10px_10px] p-[20px]`}>
