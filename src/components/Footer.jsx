...
export const Footer = () => {
    return (
        <div className='bg-black flex flex-col md:flex-row px-[25px] py-[50px] md:pt-[100px] xl:pt-[150px] md:pb-[100px] xl:pb-[150px] xl:py-[50px] rounded-[25px_25px_0_0]'>
            ...
            <div className='hidden md:block md:w-6/12 xl:w-4/12'>
                <h2 className='text-white pb-[25px] md:text-[30px] md:text-[32px] xl:text-[40px] xl:leading-[42px] font-title font-bold'>Ez izan zalantzarik nirekin kontaktuan jartzeko!</h2>
            ...
            <div className='hidden md:block md:w-7/12 xl:w-4/12'>
                <h3 className='text-white pb-[50px] md:text-[20px] md:text-[22px] xl:text-[30px] xl:leading-[32px] font-title font-bold'>
                    Sare sozialak
                </h3>
                <div className='flex flex-col'>
                    <a href='https://www.linkedin.com/in/nereasarasola/' target='_blank' className='text-white md:text-[20px] xl:text-[30px] font-paragraph'>Linkedin</a>
